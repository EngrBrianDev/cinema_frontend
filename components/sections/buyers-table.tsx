...
export function BuyersTable() {
  ...
  return (
    <div className="motion-panel rounded border-2 border-black bg-white">
      <div className="flex flex-col gap-3 border-b-2 border-black p-4 md:flex-row md:items-center md:justify-between">
        ...
        <input
          ...
          className="motion-input rounded border-2 border-black p-2"
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[640px]">
          ...
          <tbody>
            {filtered.map((buyer) => (
              <tr key={buyer.email} className="motion-table-row border-t border-outline-variant">
